    ...
    <div className="min-h-screen bg-black text-white selection:bg-white selection:text-black">
      <div className="max-w-4xl mx-auto px-6 py-20">
        ...
        <div className="mt-20 pt-10 border-t border-neutral-900">
          <h2 className="text-[13px] font-bold tracking-[0.3em] text-neutral-600 mb-8 uppercase">
            Connect
          </h2>
          ...
          <div className="grid grid-cols-2 gap-4">
            {[
              ...
              {
                label: "linkedin",
                url: "https://linkedin.com/in/mdkawsarahmed",
              },
            ].map((link) => (
              <a
                key={link.label}
              ...
              >
                ...
                <span className="text-neutral-700 group-hover:text-white">
                  -&gt;
                </span>
              </a>
            ))}
